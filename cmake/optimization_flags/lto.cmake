function(set_project_lto_opts project_name)
  # if(${CMAKE_BUILD_TYPE} STREQUAL "Debug") message(AUTHOR_WARNING "The project
  # ${PROJECT_NAME} is building in debug mode, thus no compiler flags for link
  # time optimization were added.") return() endif()
  ...
  set(GCC_LTO -flto -Werror=odr -Werror=lto-type-mismatch
